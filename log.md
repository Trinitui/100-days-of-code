...
**Today's Progress**: More work in Codepen! I got both API's working and need to tweak the layout more. I also want to get the RocketLab API in there too. 
...
**Thoughts:** I need to fix RocketPage now - CSS layout is borked on mobile
...
**Thoughts:** Skipped a day. React is hard, and setting and manipulating state is pretty difficult. I just have to get better at it, and grind through it. I love Scrimba though!
...
**Today's Progress:** Working on MongoDB Challenges
...
**Today's Progress:** Finished MongoDB challenges, now working on TimeStamp MicroService challenge
...
### Day 86 - 95: Till December 19th, 2020
